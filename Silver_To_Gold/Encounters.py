...
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "/mnt/datalakehousegen23/bronze/hosa/Archive/2024/12/10/encounters"
# MAGIC );
# MAGIC
# MAGIC CREATE OR REPLACE TEMP VIEW hosb_encounters
# MAGIC USING parquet
# MAGIC OPTIONS (
# MAGIC   path "/mnt/datalakehousegen23/bronze/hosb/Archive/2024/12/10/encounters"
# MAGIC );
# MAGIC
