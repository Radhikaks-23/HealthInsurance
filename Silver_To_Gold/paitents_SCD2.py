...
df_hosa=spark.read.parquet("/mnt/datalakehousegen23/bronze/hosa/Archive/2024/12/10/patients")
df_hosa.createOrReplaceTempView("patients_hosa")

#Reading Hospital B patient data 
df_hosb=spark.read.parquet("/mnt/datalakehousegen23/bronze/hosa/Archive/2024/12/10/patients")
