...
cptcodes_df = spark.read.csv("/mnt/datalakehousegen23/landing/cptcodes/*.csv", header=True)

#replace whitespaces in column name with underscore and convert to lowercase 
...
cptcodes_df.write.mode("overwrite").format("parquet").save("/mnt/datalakehousegen23/bronze/cptcodes")

# COMMAND ----------

cptcodes_df = spark.read.parquet("/mnt/datalakehousegen23/bronze/cptcodes")
display(cptcodes_df)
